  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-1/4 text-4xl animate-float opacity-60" style={{ animationDelay: '0.5s' }}>📊</div>
        <div className="absolute bottom-40 right-1/3 text-5xl animate-float opacity-60" style={{ animationDelay: '1.5s' }}>✨</div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 animate-fade-in max-w-3xl mx-auto" style={{ animationDelay: '0.1s' }}>
              Перша українська платформа для вчителів 1–4 класів та репетиторів. 
              Створюйте інтерактивні завдання з Математики та Української мови, 
              які діти виконують з радістю, а система перевіряє сама.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-primary/10 border border-primary/20">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Збирайте урок як LEGO — перетягніть гру, додайте кросворд, готово.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 rounded-xl bg-primary/10 border border-primary/20">
                <CheckCircle2 className="h-6 w-6 text-primary shrink-0 mt-0.5" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card variant="game" className="p-8 text-center relative overflow-hidden group">
              ...
              <CardContent className="p-0 pt-8">
                ...
                <p className="text-muted-foreground">
                  Міксуйте вправи: з'єднання пар, ребуси, кросворди, драг-ен-дроп. Або додайте посилання на Znaiemo чи LearningApps.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <Card variant="game" className="p-6">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground text-sm">
                  База готових шаблонів, структурована по семестрах.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card variant="interactive" className="p-8 group">
              ...
              <p className="text-muted-foreground text-lg">
                Економте до 5 годин на тиждень на підготовці та перевірці. 
                Зробіть свої уроки найсучаснішими в школі.
              </p>
            </Card>
            ...
            <Card variant="interactive" className="p-8 group">
              ...
              <p className="text-muted-foreground text-lg">
                Давайте учням більше цінності. Інтерактивні домашки підвищують 
                залученість та виправдовують вартість заняття.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Станьте одними з перших, хто протестує ClickClass. 
            Ваші відгуки допоможуть зробити ідеальний інструмент для української освіти.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-6 text-sm text-muted-foreground">
              <a href="#" className="hover:text-foreground transition-colors">Політика конфіденційності</a>
              <a href="#" className="hover:text-foreground transition-colors">Контакти підтримки</a>
            </div>
            <p className="text-sm text-muted-foreground">
              © 2025 ClickClass. Зроблено в Україні 🇺🇦
            </p>
          </div>
        </div>
      </footer>
